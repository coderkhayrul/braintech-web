        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('banner.index') }}" class="btn btn-dark btn-sm"><i class="uil-meeting-board"></i>
                        All Banner</a>
                </div>
                <form action="{{ route('banner.update', $banner->ban_slug) }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-9">
                                <input name="ban_title" type="text" class="form-control"
                                    value="{{ $banner->ban_title }}">
                            </div>
                        </div>

                        <div class="row mb-3 mt-3">
                            <label for="inputEmail3" class="col-3 col-form-label">Banner Middle Title <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input name="ban_mid_title" type="text" class="form-control"
                                    value="{{ $banner->ban_mid_title }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 mt-3">
                            <label for="inputEmail3" class="col-3 col-form-label">Banner Sub Title <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input name="ban_subtitle" type="text" class="form-control"
                        ...
                        <div class="row mb-3 mt-3">
                            <label for="inputEmail3" class="col-3 col-form-label">Banner Button <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input name="ban_button" type="text" class="form-control"
                                    value="{{ $banner->ban_button }}">
                            </div>
                        </div>
                        <div class="row mb-3 mt-3">
                            <label for="inputEmail3" class="col-3 col-form-label">Banner Order <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input type="number" name="ban_order" class="form-control"
                                    value="{{ $banner->ban_order }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-3 text-center">
                                @if ($banner->ban_image)
                                    <img name="ban_image" id="preview-image"
                                        src="{{ asset('uploads/banner/' . $banner->ban_image) }}" alt="image"
