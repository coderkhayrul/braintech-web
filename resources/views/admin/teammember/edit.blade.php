...
@section('admin-content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" action="{{ route('team-member.update', $data->team_slug) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="team_id" value="{{ $data->team_id }}">
                    <div class="card-header d-flex justify-content-between">
                        <strong class="fs-4"> <i class="uil-trademark-circle"></i> Edit Team Member</strong>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3 mt-3">
                                <label for="name" class="col-3 col-form-label">Designation <strong
                                        class="text-danger">*</strong></label>
                                <div class="col-12">
                                    <input type="text" value="{{ $data->team_designation }}"
                            ...
                            <div class="col-6 mb-3 mt-3">
                                <label for="name" class="col-3 col-form-label">Email <strong
                                        class="text-danger">*</strong></label>
                                <div class="col-12">
                                    <input type="text" value="{{ $data->team_email }}"
                            ...
                            <div class="col-6 mb-3 mt-3">
                                <label for="name" class="col-3 col-form-label">Phone <strong
                                        class="text-danger">*</strong></label>
                                <div class="col-12">
                                    <input type="text" value="{{ $data->team_phone }}"
                            ...
                            <div class="col-6 mb-3">
                                <label for="email" class="col-3 col-form-label">Order By <strong
                                        class="text-danger">*</strong></label>
                                <div class="col-12">
                                    <input type="number" value="{{ $data->team_order }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control @error('team_remarks') is-invalid @enderror"
                                        ...
                                        style="height: 100px">{{ $data->team_remarks }}</textarea>
                                    @error('team_remarks')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-3 text-center">
                                    @if ($data->team_image)
                                        <img id="preview-image"
                                            src="{{ asset('uploads/teammember/' . $data->team_image) }}" alt="image"
