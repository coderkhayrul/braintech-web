            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-9">
                            <input disabled type="text" value="{{ $data->team_name }}" class="form-control "
                    ...
                    <div class="row mb-3 mt-3">
                        <label for="name" class="col-3 col-form-label">Designation <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <input disabled type="text" value="{{ $data->team_designation }}" class="form-control"
                    ...
                    <div class="row mb-3 mt-3">
                        <label for="name" class="col-3 col-form-label">Email <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <input disabled type="text" value="{{ $data->team_email }}" class="form-control"
                                id="team_email" name="team_email" placeholder="Enter Email">

                        </div>
                    </div>
                    <div class="row mb-3 mt-3">
                        <label for="name" class="col-3 col-form-label">Phone <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <input disabled type="text" value="{{ $data->team_phone }}" class="form-control"
                                id="team_phone" name="team_phone" placeholder="Enter Phone">
                    ...
                    <div class="row mb-3">
                        <label for="email" class="col-3 col-form-label">Order By <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <input disabled type="number" value="{{ $data->team_order }}" class="form-control"
                                id="team_order" name="team_order" placeholder="Team Member Order">
                    ...
                    <div class="row mb-3">
                        <label for="feedback" class="col-3 col-form-label">Remarks <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <textarea disabled class="form-control" placeholder="Leave a remaks here" name="team_remarks"
                                id="team_remarks" style="height: 100px"> {{ $data->team_remarks }} </textarea>
                    ...
                    <div class="row mb-3">
                        <label for="feedback" class="col-3 col-form-label">Description <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <textarea disabled class="form-control" placeholder="Leave a Description here"
                                name="team_description" id="team_description"
                                style="height: 100px"> {{ $data->team_description }} </textarea>
