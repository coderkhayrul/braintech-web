    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Team Member Skill</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <strong class="fs-4"> <i class="uil-bag"></i> All Member Skill</strong>
                    <a href="{{ route('team-skill.create') }}" class="btn btn-dark btn-sm"><i class="uil-plus-square"></i>
                        Create Member Skill</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('team-skill.show', $data->ts_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('team-skill.edit', $data->ts_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="#" data-bs-toggle="modal" data-value="{{ $data->ts_id }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('team-skill.destroy', $data->ts_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
