...
@section('admin-content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" action="{{ route('testimonial.update', $data->tm_slug) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-header d-flex justify-content-between">
                        <strong class="fs-4"> <i class="uil-bag"></i> Update Testimonial</strong>
                    ...
                    <div class="card-body">
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-9">
                                <input type="text" value="{{ $data['tm_name'] }}"
                        ...
                        <div class="row mb-3 mt-3">
                            <label for="name" class="col-3 col-form-label">Client Position <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input type="text" value="{{ $data['tm_position'] }}"
                        ...
                        <div class="row mb-3 mt-3">
                            <label for="name" class="col-3 col-form-label">Designation <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input type="text" value="{{ $data['tm_designation'] }}"
                                    class="form-control @error('tm_designation') is-invalid @enderror" id="tm_designation"
                                    name="tm_designation" placeholder="Designation">
                        ...
                        <div class="row mb-3 mt-3">
                            <label for="name" class="col-3 col-form-label">Company Name <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input type="text" value="{{ $data['tm_company'] }}"
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-3 col-form-label">Order By <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input type="number" value="{{ $data['tm_order'] }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <textarea class="form-control @error('tm_feedback') is-invalid @enderror"
                                    ...
                                    style="height: 100px">{{ $data['tm_feedback'] }}</textarea>
                                @error('tm_feedback')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-3 text-center">
                                @if ($data['tm_image'])
                                    <img id="preview-image" src="{{ asset('uploads/testimonial/' . $data->tm_image) }}"
