        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('testimonial.index') }}" class="btn btn-dark btn-sm"><i class="uil-symbol"></i>
                        All Testimonial</a>
                </div>
                <div class="card-body">

                    <div class="row mb-3 mt-3">
                        <label for="inputEmail3" class="col-3 col-form-label">Client Name <strong
                    ...
                    <div class="row mb-3 mt-3">
                        <label for="tm_position" class="col-3 col-form-label">Client Position <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <input disabled type="text" class="form-control" value="{{ $data->tm_position }}">
                        </div>
                    </div>
                    <div class="row mb-3 mt-3">
